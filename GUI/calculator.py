...
button_add = Button(root, text="+", padx=38.5, pady=20, command=button_addition)
...
clear_screen = Button(root, text="Clear", padx=79, pady=20, command=clear)
equal_button = Button(root, text="=", padx=89, pady=20, command=button_equal)
...
equal_button.grid(row=6, column=1, columnspan=2)
